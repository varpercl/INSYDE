/****************************************************************************
** Meta object code from reading C++ file 'labeledspinboxwidget.h'
**
...
#error "The header file 'labeledspinboxwidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LabeledDoubleSpinBoxWidget_t, stringdata) + ofs \
...
const QMetaObject LabeledDoubleSpinBoxWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LabeledDoubleSpinBoxWidget.data,
      qt_meta_data_LabeledDoubleSpinBoxWidget,  qt_static_metacall, 0, 0}
};
