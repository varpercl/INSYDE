...
#include "../../ANNGraphicInterface/datarepresentationbox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DataRepresentationBox_t, stringdata) + ofs \
...
const QMetaObject DataRepresentationBox::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_DataRepresentationBox.data,
      qt_meta_data_DataRepresentationBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataRepresentationBox.stringdata))
