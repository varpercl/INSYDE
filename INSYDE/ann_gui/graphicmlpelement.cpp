...
QString GraphicMLPElement::getXML() const
{
	//TODO:
	return "";
}
...
void GraphicMLPElement::setInputElement(GraphicObject *ge)
{
...
void GraphicMLPElement::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
	...
	painter->drawImage(getContainerRect(), QImage(":imagenes/perceptron multicapa.png"));
	painter->drawText(getContainerRect(), result);
}

void GraphicMLPElement::copyClick()
{

}

void GraphicMLPElement::cutClick()
{

}

void GraphicMLPElement::pasteClick()
{

}

void GraphicMLPElement::saveClick()
{

}

void GraphicMLPElement::propertyClick()
{
...
void GraphicMLPElement::openClick()
{
}
...
void GraphicMLPElement::init(MultilayerPerceptron *mlp, TrainingSet *ts)
{
	...
	setTrainingSet(ts);
	setContainerRect(QRectF(0,0,50,50));
}
