...
/*!
 * \brief The PlayerTeam enum Indica el equipo al cual pertenece el jugador propietario de esta unidad.
 */
enum PlayerTeam{
	None,
	Team1,
...
/*!
 * \brief Un objeto @code{Unit} es considerado un tipo de agente movil (@code{MovilAgent}) especial dentro de los
 * juegos, en especial los juegos de estrategia, tiene propiedades especiales como vitalidad, energia y otras que
 * se pueden manipular para crear un juego basico.
 *
 * \class Unit
