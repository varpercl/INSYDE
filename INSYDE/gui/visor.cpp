...
void Visor::contextMenuEvent(QContextMenuEvent *event)
{
	QMenu *cntxMenu;
	...
	if(areDifferentTypes(listItems)){
		...
		//FIXME: corregir esto implementar contextMenuEvent de cada item
//		cntxMenu = dynamic_cast<GraphicObject*>(itemAt(p))->getContextMenu(new QMenu());
