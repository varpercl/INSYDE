...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TrainingSetTable_t, stringdata) + ofs \
...
const QMetaObject TrainingSetTable::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_TrainingSetTable.data,
