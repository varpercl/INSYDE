...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_IntegerSizeWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 18, 16), // "sizeValueChanged"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 3), // "arg"
QT_MOC_LITERAL(4, 40, 12), // "unitsChanged"
QT_MOC_LITERAL(5, 53, 24), // "QPair<UnitType,UnitType>"
QT_MOC_LITERAL(6, 78, 12), // "widthChanged"
QT_MOC_LITERAL(7, 91, 2), // "nw"
QT_MOC_LITERAL(8, 94, 13), // "heightChanged"
QT_MOC_LITERAL(9, 108, 2), // "nh"
QT_MOC_LITERAL(10, 111, 15), // "onHeightChanged"
QT_MOC_LITERAL(11, 127, 3), // "val"
QT_MOC_LITERAL(12, 131, 14) // "onWidthChanged"

    },
    "IntegerSizeWidget\0sizeValueChanged\0\0"
    "arg\0unitsChanged\0QPair<UnitType,UnitType>\0"
...
void IntegerSizeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sizeValueChanged((*reinterpret_cast< QSize(*)>(_a[1]))); break;
        case 1: _t->unitsChanged((*reinterpret_cast< const QPair<UnitType,UnitType>(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IntegerSizeWidget::sizeValueChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (IntegerSizeWidget::*_t)(const QPair<UnitType,UnitType> & );
...
void *IntegerSizeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IntegerSizeWidget.stringdata))
...
// SIGNAL 0
void IntegerSizeWidget::sizeValueChanged(QSize _t1)
{
...
// SIGNAL 1
void IntegerSizeWidget::unitsChanged(const QPair<UnitType,UnitType> & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
