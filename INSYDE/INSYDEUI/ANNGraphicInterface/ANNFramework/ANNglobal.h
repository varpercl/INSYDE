...
//	typedef concurrent_vector<double> CDblVector;
//	typedef concurrent_vector<concurrent_vector<double> > CDbl2DMatrix;
//	typedef concurrent_vector<concurrent_vector<concurrent_vector<double> > > CDbl3DMatrix;

//	typedef vector<double> DoubleVector;
//	typedef vector<vector<double> > Double2DMatrix;
...
//	typedef vector<vector<long> > Long2DMatrix;
//	typedef vector<vector<vector<long> > > Long3DMatrix;
	...
	*/
	...
	concurrent_vector<double> concGetRandomValues(int nvalues);

	vector<double> getRandomValues(int nvalues, double min, double max);

	concurrent_vector<double> concGetRandomValues(int nvalues, double min, double max);
