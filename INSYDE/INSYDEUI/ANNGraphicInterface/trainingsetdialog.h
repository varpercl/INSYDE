...
#include "ANNFramework/trainingsetfile.h"
...
//		dblTargetsElongValue;
		...
		*ts;
		...
		//Inputs Normalization Widget
		*inw,

		//Targets Normalization Widget
		*tnw;
		...
		DataRepresentationBox *gbGraphicTargetsRepresentation;
		DataRepresentationBox *gbGraphicInputsRepresentation;
		QVBoxLayout *mainVerticalLayout;
		QGridLayout *mainSubHorizontalLayout;
		QVBoxLayout *inputsVerticalLayout;
		QVBoxLayout *targetsVerticalLayout;
		QHBoxLayout *inputsPatternToolbar;
		...
		*tstTargets;
		 ...
		 * @param outputs
		 */
		void init(const vector<vector<double> > &inputs, int is, const vector<vector<double> > &outputs, int ts);

		/**
		 * @brief initDialog
		 * @param ts
		 */
		void init(const vector<MultilayerPerceptronPattern*> ts);
	...
	private slots:
		...
		void onSaveTrainingSet();

		void onOpenTrainingSet();

		void onImportTrainingSet();
		...
		void onInputsTableActivated(const QModelIndex &index);
;
		void onTargetsTableActivated(const QModelIndex &index);
		...
		void onInputsNormalizationTypeChanged(Normalization nt);

		void onTargetsNormalizationTypeChanged(Normalization nt);
