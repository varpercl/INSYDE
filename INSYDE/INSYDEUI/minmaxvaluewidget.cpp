...
void DoubleMinMaxValueWidget::setDecimals(int n)
{
	ui->sbMax->setDecimals(n);
	ui->sbMin->setDecimals(n);
}

int DoubleMinMaxValueWidget::getDecimals() const
{
	return ui->sbMax->decimals();
}
