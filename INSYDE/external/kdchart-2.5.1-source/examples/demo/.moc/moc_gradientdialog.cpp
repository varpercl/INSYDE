...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GradientDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 32, 8), // "gradient"
QT_MOC_LITERAL(4, 41, 9) // "QGradient"

    },
    "GradientDialog\0gradientChanged\0\0"
    "gradient\0QGradient"
};
...
void GradientDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GradientDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GradientDialog::gradientChanged)) {
                *result = 0;
            }
        }
    }
...
void *GradientDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GradientDialog.stringdata))
...
// SIGNAL 0
void GradientDialog::gradientChanged()
{
