...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ZoomWidget_t, stringdata) + ofs \
...
const QMetaObject ZoomWidget::staticMetaObject = {
    { &KDChart::Widget::staticMetaObject, qt_meta_stringdata_ZoomWidget.data,
...
void *ZoomWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZoomWidget.stringdata))
        return static_cast<void*>(const_cast< ZoomWidget*>(this));
    return KDChart::Widget::qt_metacast(_clname);
}

int ZoomWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = KDChart::Widget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
