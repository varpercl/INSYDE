...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FrameWidget_t, stringdata) + ofs \
...
const QMetaObject FrameWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FrameWidget.data,
      qt_meta_data_FrameWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FrameWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FrameWidget.stringdata))
