...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TimeAxis_t, stringdata) + ofs \
...
const QMetaObject TimeAxis::staticMetaObject = {
    { &KDChart::CartesianAxis::staticMetaObject, qt_meta_stringdata_TimeAxis.data,
      qt_meta_data_TimeAxis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TimeAxis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TimeAxis.stringdata))
