...
#include "../../ECGraphicInterface/agent.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Agent_t, stringdata) + ofs \
...
const QMetaObject Agent::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_Agent.data,
