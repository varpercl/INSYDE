 ...
 * neuronal
 */
class WeightLine : public QObject, public QGraphicsLineItem
{
	public:
...
//		WeightEditProxy* piWeightEdit;
		...
		void initWL(SimplePerceptron *sp, int index, double weight = 0, double maxW = 100, double minW = -100, int lineWidth = 2);
};
