...
#include "../../../INSYDE/ann_gui/samplesdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SamplesDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SamplesDialog_t qt_meta_stringdata_SamplesDialog = {
    {
QT_MOC_LITERAL(0, 0, 13), // "SamplesDialog"
QT_MOC_LITERAL(1, 14, 23), // "on_cbAllSamples_toggled"
...
const QMetaObject SamplesDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SamplesDialog.data,
      qt_meta_data_SamplesDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SamplesDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SamplesDialog.stringdata0))
