...
/**
  ...
  */
class ANNFRAMEWORK_EXPORT SimplePerceptron
{
	...
	private:
		  ...
		  /**
			...
			*/
		  void initPerceptron(int ninputs, double *weights, TransferFunctionType tf, LearningRule lr);
		  ...
		  /**
			...
			*/
		  void initPerceptron(int ninputs, TransferFunctionType tf, LearningRule lr);
		  ...
		  /**
			...
			*/
		  void initPerceptron(vector<double> weights, TransferFunctionType tf, LearningRule lr);

};

class ANNFRAMEWORK_EXPORT PerceptronTrainingPattern : public SimpleInputPattern
{
	public:
