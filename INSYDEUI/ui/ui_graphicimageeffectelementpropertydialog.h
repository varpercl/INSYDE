...
public:
    ...
    {
        GraphicImageEffectElementPropertyDialog->setWindowTitle(QApplication::translate("GraphicImageEffectElementPropertyDialog", "Dialog", 0));
        ...
        ___qlistwidgetitem->setText(QApplication::translate("GraphicImageEffectElementPropertyDialog", "Blanco y negro", 0));
        QListWidgetItem *___qlistwidgetitem1 = lwEffects->item(1);
        ___qlistwidgetitem1->setText(QApplication::translate("GraphicImageEffectElementPropertyDialog", "Escala de grises", 0));
