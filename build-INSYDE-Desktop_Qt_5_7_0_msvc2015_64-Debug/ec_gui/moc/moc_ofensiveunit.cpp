...
#include "../../../INSYDE/ec_gui/ofensiveunit.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OfensiveUnit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OfensiveUnit_t qt_meta_stringdata_OfensiveUnit = {
    {
QT_MOC_LITERAL(0, 0, 12), // "OfensiveUnit"
QT_MOC_LITERAL(1, 13, 13), // "unitHasKilled"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "Unit*"
QT_MOC_LITERAL(4, 34, 2) // "un"

    },
    "OfensiveUnit\0unitHasKilled\0\0Unit*\0un"
};
...
const QMetaObject OfensiveUnit::staticMetaObject = {
    { &Unit::staticMetaObject, qt_meta_stringdata_OfensiveUnit.data,
      qt_meta_data_OfensiveUnit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OfensiveUnit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OfensiveUnit.stringdata0))
